        ...
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-2 font-medium tracking-wide">
              Manage your professional performance and account preferences.
            </p>
          </div>
          <button 
            onClick={() => router.push("/dashboard/settings/edit")}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="bg-gradient-to-b from-[#111] to-[#0a0a0a] border border-slate-800 rounded-[2.5rem] p-8 text-center">
                   ...
                   <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/20 rounded-full">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-orange-500">
                        {profile?.plans?.title || "Standard Tier"}
                      </span>
                   </div>
                </div>

                <div className="bg-[#111] border border-slate-800 rounded-3xl p-6">
                   <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-600 mb-4">Quick Stats</h3>
                   <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-bold uppercase italic">{profile?.role || 'Trainer'}</span>
                      </div>
                   </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-8 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <StatCard label="Total Trainees" value="24" icon={Users} color="text-blue-500" />
                  <StatCard label="Workouts" value="142" icon={Dumbbell} color="text-orange-500" />
                  <StatCard label="Evaluations" value="89" icon={LayoutGrid} color="text-purple-500" />
                </div>
                ...
                <div className="bg-[#111] border border-slate-800 rounded-[2.5rem] overflow-hidden">
                   <div className="p-8 border-b border-slate-800 flex justify-between items-center">
                      <h3 className="text-sm font-black uppercase tracking-widest flex items-center gap-3">
                        <Database size={18} className="text-orange-500" /> Platform Configuration
                      </h3>
                   ...
                   <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <ConfigItem 
                        title="Integrations" 
                        desc="Connect Stripe, Zoom, and Google Calendar." 
                        status="Coming Soon" 
                        icon={Zap} 
                      />
                      <ConfigItem 
               ...
               {profile?.role === "trainer" && (
                <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-3xl p-8 flex flex-col md:flex-row justify-between items-center gap-6 shadow-2xl shadow-orange-500/20 animate-in fade-in zoom-in duration-500">
                  <div>
                    <h3 className="text-2xl font-black text-black uppercase italic tracking-tighter">
                      Upgrade to Pro
                    </h3>
                    <p className="text-black/70 text-sm font-bold">
                      Unlock advanced body analytics and AI routines.
                    </p>
                  </div>
                  <button 
