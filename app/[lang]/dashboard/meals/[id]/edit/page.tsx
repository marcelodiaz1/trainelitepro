...
export default function EditMealPage() {
  ...
  const handleUpdate = async () => {
    if (!name || selectedIngredients.length === 0) return alert("Missing data.");
    setSaving(true);
    ...
    try {
      ...
      // 2. Batch Insert new ingredients (Simple approach: create new refs)
  ...
  if (loading) return <div className="bg-[#050505] min-h-screen flex items-center justify-center"><Loader2 className="animate-spin text-orange-500" /></div>;
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="p-6 border-b border-slate-800 flex justify-between items-center bg-[#0b0b0b]">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-black uppercase italic tracking-tighter">Edit meal: {name}</h1>
          </div>
          <button 
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <section className="bg-[#0b0b0b] border border-slate-800 rounded-2xl overflow-hidden shadow-2xl relative h-64 group">
                ...
                <div className="absolute bottom-6 left-6">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-500 mb-2 block">Meal Visual Reference</span>
                  <h2 className="text-3xl font-black uppercase italic tracking-tighter">{name || "Unnamed"}</h2>
                </div>
              </section>
              ...
              <section className="bg-[#0b0b0b] border border-slate-800 rounded-2xl p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-[9px] font-black text-slate-500 uppercase mb-2">Change Image</label>
            ...
            <div className="space-y-6">
              <section className="bg-orange-600 rounded-2xl p-6 shadow-2xl shadow-orange-900/20 relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-[10px] font-black uppercase text-orange-200 tracking-widest mb-6 italic">Meal Summary</h3>
                  <div className="space-y-6">
